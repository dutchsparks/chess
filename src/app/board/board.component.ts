...
clickTile (tile) {
  if (!this.currentPiece) {                            //state important, means piece selected
    this.state = true;
    this.currentPiece = tile.piece;
    this.currentTile = tile;
  } else if (this.currentPiece) {
    console.log(this.currentPiece.type);
    tile.piece = this.currentTile.piece;
    this.currentTile.piece = null;            //raar dat dit het vlak leeg maakt.
    this.state = false;
  }
}
